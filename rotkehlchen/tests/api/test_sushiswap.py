...
def get_expected_trades():
    ...
    return [AMMTrade(
        ...
        base_asset=EvmToken('0xdAC17F958D2ee523a2206206994597C13D831ec7'),
        quote_asset=EvmToken('0x4b4D2e899658FB59b1D518b68fe836B100ee8958'),
        ...
        swaps=[AMMSwap(
            ...
            token0=EvmToken('0x4b4D2e899658FB59b1D518b68fe836B100ee8958'),
        ...
        trade_type=TradeType.BUY,
        base_asset=EvmToken('0x368B3a58B5f49392e5C9E4C998cb0bB966752E51'),
        quote_asset=EvmToken('0xA0b86991c6218b36c1d19D4a2e9Eb0cE3606eB48'),
        ...
        swaps=[AMMSwap(
            ...
            location=Location.SUSHISWAP,
            token0=EvmToken('0xA0b86991c6218b36c1d19D4a2e9Eb0cE3606eB48'),
            ...
            timestamp=Timestamp(1609303966),
            location=Location.SUSHISWAP,
            token0=EvmToken('0x368B3a58B5f49392e5C9E4C998cb0bB966752E51'),
            token1=EvmToken('0xdAC17F958D2ee523a2206206994597C13D831ec7'),
        ...
        trade_type=TradeType.BUY,
        base_asset=EvmToken('0xdAC17F958D2ee523a2206206994597C13D831ec7'),
        quote_asset=EvmToken('0x368B3a58B5f49392e5C9E4C998cb0bB966752E51'),
...
EXPECTED_EVENTS_BALANCES_1 = [
    SushiswapPoolEventsBalance(
        ...
        token0=EvmToken('0xC02aaA39b223FE8D0A0e5C4F27eAD9083C756Cc2'),
        token1=EvmToken('0xdBdb4d16EdA451D0503b854CF79D55697F90c8DF'),
        events=[
            SushiswapPoolEvent(
