...
def test_half_asset_prices_are_updated(mock_uniswap):
    ...
    known_asset_price = {A_USDTevm_address: USD_PRICE_USDT}
...
def test_all_asset_prices_are_updated(mock_uniswap):
    ...
    known_asset_price = {
        A_WETHevm_address: USD_PRICE_WETH,
        A_USDTevm_address: USD_PRICE_USDT,
    }
    unknown_asset_price = {
        A_SHLevm_address: USD_PRICE_SHL,
        A_CARevm_address: USD_PRICE_CAR,
    }
